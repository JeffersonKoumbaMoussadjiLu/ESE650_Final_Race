...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        csv_data = np.loadtxt(
            "/home/nvidia/f1tenth_ws/src/pure_pursuit/scripts/ICRA_smoothed_final_waypoints.csv",
            delimiter=",",
            skiprows=0
        )
        ...
        self.speed_zones = [
            {
                "name": "Box1",
                "corners": [(-1.42, -5.57), (14.34, -9.5), (13.94, -11.25), (-1.72, -7.19)],
                "speed": 7.0,
                "lookahead": 5.0
            },
            {
                "name": "Box2",
                "corners": [(-5.75, -4.75),(-1.42, -5.57), (-1.72, -7.19), (-6.06, -6.28)],
                "speed": 3.0,
                "lookahead": 2.0
            },
            {
                "name": "Box3",
                "corners": [(-4.90, -0.23), (-2.21, -0.96), (-2.62, -5.15), (-5.75, -4.75)],
                "speed": 3.0,
                "lookahead": 2.0
            },
            {
                "name": "Box4",
                "corners": [(-3.82, 2.11), (-0.88, 1.72), (-1.43, -1.00), (-4.90, -0.23)],
                "speed": 3.5,
                "lookahead": 2.0
            },
            {
                "name": "Box5",
                "corners": [(-0.88, 1.72), (10.43, -0.43), (10.41, -1.89), (-1.32, -0.32)],
                "speed": 6.0,
                "lookahead": 3.0
            },
            {
                "name": "Box6",
                "corners": [(11.43, -0.43), (21.17,-1.92),(20.48, -5.59), (11.38, -3.41)],
                "speed": 2.0,
                "lookahead": 1.0
            },
            {
                "name": "Box7",
                "corners": [(11.38, -3.41),(20.48, -5.59), (20.11, -9.09), (11.36, -5.96)],
                "speed": 5.0,
                "lookahead": 3.0
            },
            {
                "name": "Box8",
                "corners": [(0.92, -0.78), (11.41, -1.89), (11.36, -5.96), (1.12, -3.31)],
                "speed": 4.0,
                "lookahead": 1.5
            },
            {
                "name": "Box9",
                "corners": [(-1.83, -0.80),(0.92, -0.78), (1.00, -5.83), (-2.62, -5.15)],
                "speed": 2.0,
                "lookahead": 1.5
            },
            {
                "name": "Box10",
                "corners": [(1.12, -3.31), (13.61, -7.22), (13.34, -9.5), (1.00, -5.83)],
                "speed": 5.0,
                "lookahead": 2.0
            },
            {
                "name": "Box11",
                "corners": [(14.61, -7.22), (20.11, -9.09), (19.65, -12.65), (13.94, -11.25)],
                "speed": 1.0,
                "lookahead": 2.0
            },
        ]
